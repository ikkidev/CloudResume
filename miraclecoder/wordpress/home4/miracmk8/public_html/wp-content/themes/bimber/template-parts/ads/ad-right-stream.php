<?php
/**
 * The Template for displaying ad on the right side of a stream template.
 *
...
set_query_var( 'plugin_required_notice_slot_id', esc_html__( 'On the right side of stream collection', 'bimber' ) );
?>

<?php if ( bimber_can_use_plugin( 'quick-adsense-reloaded/quick-adsense-reloaded.php' ) ) : ?>

	<?php if ( quads_has_ad( 'bimber_right_stream' ) ) : ?>

		<div class="g1-advertisement g1-advertisement-right-stream">

			<?php quads_ad( array( 'location' => 'bimber_right_stream' ) ); ?>
...
<?php if ( bimber_can_use_plugin( 'ad-ace/ad-ace.php' ) ) : ?>
	...
	<?php if (  adace_is_ad_slot( 'bimber_right_stream' ) ) : ?>

		<div class="g1-advertisement g1-advertisement-right-stream">

			<?php echo bimber_sanitize_ad( adace_get_ad_slot( 'bimber_right_stream' ) ); ?>
