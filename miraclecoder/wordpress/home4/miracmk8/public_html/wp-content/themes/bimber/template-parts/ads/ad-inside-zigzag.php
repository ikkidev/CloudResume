...
set_query_var( 'plugin_required_notice_slot_id', esc_html__( 'Inside zigzag collection', 'bimber' ) );
...
<li class="g1-collection-item g1-injected-unit">
	<?php if ( bimber_can_use_plugin( 'quick-adsense-reloaded/quick-adsense-reloaded.php' ) ) : ?>
		...
		<?php if ( quads_has_ad( 'bimber_inside_zigzag' ) ) : ?>

			<div class="g1-advertisement g1-advertisement-inside-zigzag">

				<?php quads_ad( array( 'location' => 'bimber_inside_zigzag' ) ); ?>
	...
	<?php if ( bimber_can_use_plugin( 'ad-ace/ad-ace.php' ) ) : ?>
		...
		<?php if (  adace_is_ad_slot( 'bimber_inside_zigzag' ) ) : ?>

			<div class="g1-advertisement g1-advertisement-inside-zigzag">

				<?php
					$ad = bimber_sanitize_ad( adace_get_ad_slot( 'bimber_inside_zigzag', $bimber_ad_offset + 1 ) );
					if ( empty( $ad ) ) {
