		...
		<div class="g1-collection-viewport">
			<ul class="g1-collection-items">
				<?php while ( $bimber_query->have_posts() ) : $bimber_query->the_post(); ?>
					...
					<?php if ( $bimber_query->current_post % 4 ) : ?>
						<li class="g1-collection-item g1-collection-item-grid-m">
							<?php
					...
					<?php else : ?>
						<li class="g1-collection-item g1-collection-item-tile">
							<?php get_template_part( 'template-parts/content-tile-xxl', get_post_format() ); ?>
						</li>
					<?php endif; ?>
