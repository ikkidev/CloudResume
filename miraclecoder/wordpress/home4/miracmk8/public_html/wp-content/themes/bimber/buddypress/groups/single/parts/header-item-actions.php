...
<div id="item-actions" class="group-item-actions">
	...
	<?php if ( bp_current_user_can( 'groups_access_group' ) ) : ?>
		...
		<dl class="moderators-lists">
			<dt class="moderators-title g1-epsilon g1-epsilon-1st"><?php esc_html_e( 'Administrators', 'buddypress' ); ?></dt>
		...
		?>
			...
			<dl class="moderators-lists">
				<dt class="moderators-title g1-epsilon g1-epsilon-1st"><?php esc_html_e( 'Moderators', 'buddypress' ); ?></dt>
