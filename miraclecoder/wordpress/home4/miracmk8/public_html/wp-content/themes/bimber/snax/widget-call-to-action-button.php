...
<div class="snax-cta">
	...
	<div class="snax-cta-body">
		...
		<form action="<?php echo esc_url( $url[0] ); ?>" method="get">
			<button class="g1-button-solid g1-button g1-button-wide g1-button-l snax-button snax-button-create  snax-format-<?php echo esc_attr( $snax_cta_icon );?>"><i class="snax-format-icon"></i><?php echo esc_html( $snax_cta_button_label ); ?></button>
