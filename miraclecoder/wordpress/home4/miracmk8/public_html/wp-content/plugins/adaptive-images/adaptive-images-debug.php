<?php
    ...
    function adaptive_images_debug_diagnostic_info ( $echo = true ) {
        ...
        $debug['WP version']          = get_bloginfo( 'version' );
        ...
        $debug['WP ABSPATH']          = esc_html( ABSPATH );
        $debug['WP HOME']             = defined( 'WP_HOME' ) ? esc_html( WP_HOME ) : 'N/A';
        ...
        $debug['UPLOADS']             = defined( 'UPLOADS' ) ? esc_html( UPLOADS ) : 'N/A';
