...
<div class="photomix-editor photomix-tpl-3-01">
	...
	<div class="photomix-actions-wrapper">
		...
		<div class="photomix-image-actions photomix-image-actions-disabled photomix-image-middle">
...
<script type="text/javascript">
	(function(ctx) {
		...
		var maskWidth 	 = Math.round( ( canvasWidth - 2 * gapWidth ) / 3 );
		...
		ctx.photomixEditorConfig = {
			...
			masks: {
				...
				middle: {
					...
					top:		0,
					fill:		'<?php echo sanitize_hex_color( $photomix_editor['background_color'] ) ?>',
					image:      <?php echo photomix_get_mask_js_config( 'middle' ); ?>
				},
				right: {
					width: 		maskWidth,
					height: 	canvasHeight,
